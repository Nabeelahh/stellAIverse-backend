  ...
  @ApiResponse({ 
    ...
    schema: {
      ...
      properties: {
        ...
        description: { type: "string", example: "Comprehensive API for StellAIverse services" },
        modules: { 
          type: "array", 
          items: { type: "string" },
  ...
  @ApiResponse({ 
    ...
    schema: {
      ...
      properties: {
        ...
        userAddress: { type: "string", example: "0x1234567890abcdef1234567890abcdef1234567890" }
      }
    }
  })
  @ApiResponse({ 
